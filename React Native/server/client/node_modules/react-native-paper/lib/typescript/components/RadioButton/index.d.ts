...
declare const RadioButton: (import("react").ComponentClass<Pick<import("react-native-paper/lib/typescript/components/RadioButton/RadioButton").Props, "color" | "onPress" | "testID" | "disabled" | "value" | "status" | "uncheckedColor"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<ReactNativePaper.Theme> | undefined;
}, any> & import("@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<(import("react").ComponentClass<import("react-native-paper/lib/typescript/components/RadioButton/RadioButton").Props, any> & ((props: import("react-native-paper/lib/typescript/components/RadioButton/RadioButton").Props) => JSX.Element)) | (import("react").FunctionComponent<import("react-native-paper/lib/typescript/components/RadioButton/RadioButton").Props> & ((props: import("react-native-paper/lib/typescript/components/RadioButton/RadioButton").Props) => JSX.Element)), {}> & {
    Group: {
    ...
    Item: (import("react").ComponentClass<Pick<import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props, "label" | "style" | "color" | "onPress" | "testID" | "accessibilityLabel" | "labelStyle" | "disabled" | "value" | "mode" | "status" | "uncheckedColor"> & {
        theme?: import("@callstack/react-theme-provider").$DeepPartial<ReactNativePaper.Theme> | undefined;
    }, any> & import("@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<(import("react").ComponentClass<import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props, any> & {
        ({ value, label, style, labelStyle, onPress, disabled, color, uncheckedColor, status, theme: { colors }, accessibilityLabel, testID, mode, }: import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props): JSX.Element;
        displayName: string;
    }) | (import("react").FunctionComponent<import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props> & {
        ({ value, label, style, labelStyle, onPress, disabled, color, uncheckedColor, status, theme: { colors }, accessibilityLabel, testID, mode, }: import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props): JSX.Element;
        displayName: string;
    }), {}>) | (import("react").FunctionComponent<Pick<import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props, "label" | "style" | "color" | "onPress" | "testID" | "accessibilityLabel" | "labelStyle" | "disabled" | "value" | "mode" | "status" | "uncheckedColor"> & {
        theme?: import("@callstack/react-theme-provider").$DeepPartial<ReactNativePaper.Theme> | undefined;
    }> & import("@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<(import("react").ComponentClass<import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props, any> & {
        ({ value, label, style, labelStyle, onPress, disabled, color, uncheckedColor, status, theme: { colors }, accessibilityLabel, testID, mode, }: import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props): JSX.Element;
        displayName: string;
    }) | (import("react").FunctionComponent<import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props> & {
        ({ value, label, style, labelStyle, onPress, disabled, color, uncheckedColor, status, theme: { colors }, accessibilityLabel, testID, mode, }: import("react-native-paper/lib/typescript/components/RadioButton/RadioButtonItem").Props): JSX.Element;
...
}) | (import("react").FunctionComponent<Pick<import("react-native-paper/lib/typescript/components/RadioButton/RadioButton").Props, "color" | "onPress" | "testID" | "disabled" | "value" | "status" | "uncheckedColor"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<ReactNativePaper.Theme> | undefined;
