...
UFC_data = pd.read_csv('/home/roroblacc/Desktop/FYpDeploytest/PresentationFolder/WebAPP/MlModels/clean_dataset.csv')
...
model.fit(X_train, y_train, verbose=True, early_stopping_rounds=10, eval_metric='error', eval_set=[(X_test, y_test)])
